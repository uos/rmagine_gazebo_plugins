#ifndef RMAGINE_GAZEBO_PLUGINS_GZ_RMAGINE_VULKAN_MAP_SYSTEM_HPP
#define RMAGINE_GAZEBO_PLUGINS_GZ_RMAGINE_VULKAN_MAP_SYSTEM_HPP
...
// architecture rationale and rmagine_vulkan_map_system.cpp for the
// incremental sync algorithm (identical structure, VulkanScene/VulkanInst
// API instead of EmbreeScene/EmbreeInstance -- modeled directly on
// RmagineOptixMapSystem, since Vulkan's acceleration structure build/update
// split closest mirrors OptiX's).
class RmagineVulkanMapSystem
  : public gz::sim::System,
    public gz::sim::ISystemConfigure,
    public gz::sim::ISystemPostUpdate
{
public:
  RmagineVulkanMapSystem() = default;
  ~RmagineVulkanMapSystem() override = default;
...
private:
  ...
  rmagine::VulkanGeometryPtr BuildVisualInstance(
  ...
  std::unordered_map<PrimitiveSceneId, rmagine::VulkanScenePtr> primitive_cache_;
  std::unordered_map<std::string, rmagine::VulkanScenePtr> mesh_cache_;
};

}  // namespace rmagine_gazebo_plugins

#endif  // RMAGINE_GAZEBO_PLUGINS_GZ_RMAGINE_VULKAN_MAP_SYSTEM_HPP
